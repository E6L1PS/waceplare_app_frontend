...
interface FavoritesAdOnClickListener {
...
class FavoritesAdapter(private val adOnClickListener: FavoritesAdOnClickListener) :
    RecyclerView.Adapter<FavoritesAdapter.FavoritesVH>(), View.OnClickListener {
        ...
        with(holder.binding) {
            ...
            if (!ad.status) {
                val color = ContextCompat.getColor(
                    ...
                    com.itacademy.theme.R.color.gray_main
                )
